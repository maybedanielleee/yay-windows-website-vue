<template>
  <div>
    ...
    <h2 class="header">Danielle Chaffin</h2>
    <h4 class="subtitle" style="padding-bottom: 10px">
      Solutions Engineer | 3rd Generation in Logistics | Occassional Pot Stirrer
    </h4>
    <h4 class="subtitle">Tennessee 📍</h4>
    ...
    <div class="inner-content">
      ...
      <p class="paragraph">
        Hello there! I am Don from Singapore and I am an
        {{ new Date().getFullYear() - 2003 }} year old Software Engineer who's
        extremely passionate in both programming and design for both the web and
        iOS platform. I am currently working as a software engineer at Ministry
        of Defence Singapore, working on exciting projects with React Native and
        Vue3.
      </p>
      <p class="paragraph">
        I have worked with a mixture of design and frontend/backend
        technologies, be it for Web Development, iOS Development and
    ...
    <div class="inner-content">
      ...
      <p class="paragraph">
        ...
        SAF's OMNIA application. The application is a React Native mobile
        application that aims to provide an app that targets troopers deployed
        for local and overseas combat exercise. The app has integrated tracking
        functionality for troop movements, open reporting channels and Cat One
        lightning alert updates in the field. An admin portal is also available
        for commanders to manage their vehicles, track their troop movements and
        send out alerts to their troops.
      </p>
    </div>
